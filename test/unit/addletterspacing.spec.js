...
test(`AddLetterSpacing - Add a letter space to the last line for single line font with one color`, () => {
	expect( AddLetterSpacing( ['','',''], 1, [' '], 1, ['red'], 1 ) ).toEqual( ['','','\u001b[38;2;255;0;0m \u001b[39m'] );
});


test(`AddLetterSpacing - Add a letter space to the last line for single line font with multiple colors`, () => {
	expect( AddLetterSpacing( ['','',''], 1, ['<c1> </c1>'], 2, ['red', 'red'], 1 ) ).toEqual( ['','','\u001b[38;2;255;0;0m \u001b[39m'] );
	expect( AddLetterSpacing( ['','',''], 1, ['<c2>#</c2>'], 2, ['red', 'red'], 1 ) ).toEqual( ['','','\u001b[38;2;255;0;0m#\u001b[39m'] );
});
...
test(`AddLetterSpacing - Add a letter space to the last line for multiple line font with one color`, () => {
	expect( AddLetterSpacing( ['','','','','',''], 3, [' ',' ',' '], 1, ['red'], 1 ) )
		.toEqual( ['','','','\u001b[38;2;255;0;0m \u001b[39m','\u001b[38;2;255;0;0m \u001b[39m','\u001b[38;2;255;0;0m \u001b[39m'] );
	expect( AddLetterSpacing( ['','','','','',''], 3, ['_','_','_'], 1, ['red'], 1 ) )
		.toEqual( ['','','','\u001b[38;2;255;0;0m_\u001b[39m','\u001b[38;2;255;0;0m_\u001b[39m','\u001b[38;2;255;0;0m_\u001b[39m'] );
});


test(`AddLetterSpacing - Add a letter space to the last line for multiple line font with multiple colors`, () => {
	expect( AddLetterSpacing( ['','','','','',''], 3, ['<c1> </c1>','<c1> </c1>','<c1> </c1>'], 2, ['red', 'red'], 1 ) )
		.toEqual( ['','','','\u001b[38;2;255;0;0m \u001b[39m','\u001b[38;2;255;0;0m \u001b[39m','\u001b[38;2;255;0;0m \u001b[39m'] );
	expect( AddLetterSpacing( ['','','','','',''], 3, ['<c2> </c2>','<c2> </c2>','<c2> </c2>'], 2, ['red', 'red'], 1 ) )
		.toEqual( ['','','','\u001b[38;2;255;0;0m \u001b[39m','\u001b[38;2;255;0;0m \u001b[39m','\u001b[38;2;255;0;0m \u001b[39m'] );

	expect( AddLetterSpacing( ['','','','','',''], 3, ['<c1>_</c1>','<c1>_</c1>','<c1>_</c1>'], 2, ['red', 'red'], 1 ) )
		.toEqual( ['','','','\u001b[38;2;255;0;0m_\u001b[39m','\u001b[38;2;255;0;0m_\u001b[39m','\u001b[38;2;255;0;0m_\u001b[39m'] );
	expect( AddLetterSpacing( ['','','','','',''], 3, ['<c2>_</c2>','<c2>_</c2>','<c2>_</c2>'], 2, ['red', 'red'], 1 ) )
		.toEqual( ['','','','\u001b[38;2;255;0;0m_\u001b[39m','\u001b[38;2;255;0;0m_\u001b[39m','\u001b[38;2;255;0;0m_\u001b[39m'] );
});
