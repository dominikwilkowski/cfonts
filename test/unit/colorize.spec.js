...
test(`Colorize - Strings with one color are replaced`, () => {
	...
	expect( Colorize( test, 1, ['red'] ) ).toEqual('\u001b[38;2;255;0;0mtest string with one color placeholders\u001b[39m');
});
...
test(`Colorize - Strings with two colors are replaced`, () => {
	...
	expect( Colorize( test, 2, ['red', '#ff8800'] ) ).toEqual('test string \u001b[38;2;255;0;0mwith\u001b[39m one \u001b[38;2;255;136;0mcolor\u001b[39m placeholders');
});
