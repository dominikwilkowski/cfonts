...
fn get_all_tests() -> Vec<Test> {
	...
	let tests = vec![
		...
		// Raw mode string tests
		// Last line break in expected results in tests is created by console output, therefore it is not expected
		// to be '\r\n'
		Test {
			name: String::from("Raw mode string test"),
			args: vec!["test".to_string(), "--raw-mode".to_string()],
			fixture: concat!(
			"\r\n\r\n",
			" ████████╗ ███████╗ ███████╗ ████████╗\r\n",
			" ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
		...
		Test {
			name: String::from("Raw mode string test (short flag)"),
			args: vec!["test".to_string(), "-r".to_string()],
			fixture: concat!(
			"\r\n\r\n",
			" ████████╗ ███████╗ ███████╗ ████████╗\r\n",
			" ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
		...
		Test {
			name: String::from("Align center raw mode string"),
			args: vec!["test".to_string(), "-a".to_string() ,"center".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				"                      ████████╗ ███████╗ ███████╗ ████████╗\r\n",
				"                      ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
				"                         ██║    █████╗   ███████╗    ██║   \r\n",
		...
		Test {
			name: String::from("Align right raw mode string"),
			args: vec!["test".to_string(), "-a".to_string() ,"right".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				"                                           ████████╗ ███████╗ ███████╗ ████████╗\r\n",
				"                                           ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
				"                                              ██║    █████╗   ███████╗    ██║   \r\n",
		...
		Test {
			name: String::from("Align top raw mode string"),
			args: vec!["test".to_string(), "-a".to_string() ,"top".to_string(), "--raw-mode".to_string()],
			fixture: concat!("",
				" ████████╗ ███████╗ ███████╗ ████████╗\r\n",
				" ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
				"    ██║    █████╗   ███████╗    ██║   \r\n",
		...
		Test {
			name: String::from("Align bottom raw mode string"),
			args: vec!["test".to_string(), "-a".to_string() ,"bottom".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n\r\n\r\n",
				" ████████╗ ███████╗ ███████╗ ████████╗\r\n",
				" ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
				"    ██║    █████╗   ███████╗    ██║   \r\n",
		...
		Test {
			name: String::from("Letter spacing 2 raw mode string"),
			args: vec!["test".to_string(), "-l".to_string() ,"2".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				"  ████████╗  ███████╗  ███████╗  ████████╗\r\n",
				"  ╚══██╔══╝  ██╔════╝  ██╔════╝  ╚══██╔══╝\r\n",
				"     ██║     █████╗    ███████╗     ██║   \r\n",
		...
		Test {
			name: String::from("Letter spacing 10 raw mode string"),
			args: vec!["test".to_string(), "-l".to_string() ,"10".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				"          ████████╗          ███████╗          ███████╗          ████████╗\r\n",
				"          ╚══██╔══╝          ██╔════╝          ██╔════╝          ╚══██╔══╝\r\n",
				"             ██║             █████╗            ███████╗             ██║   \r\n",
		...
		Test {
			name: String::from("Line break raw mode string"),
			args: vec!["test|line".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				" ████████╗ ███████╗ ███████╗ ████████╗\r\n",
				" ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
				"    ██║    █████╗   ███████╗    ██║   \r\n",
		...
		Test {
			name: String::from("Line height raw mode string"),
			args: vec!["test|line".to_string(), "-z".to_string(), "5".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				" ████████╗ ███████╗ ███████╗ ████████╗\r\n",
				" ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
				"    ██║    █████╗   ███████╗    ██║   \r\n",
		...
		Test {
			name: String::from("Spaceless raw mode string"),
			args: vec!["test".to_string(), "-s".to_string(), "--raw-mode".to_string()],
			fixture: concat!("",
				" ████████╗ ███████╗ ███████╗ ████████╗\r\n",
				" ╚══██╔══╝ ██╔════╝ ██╔════╝ ╚══██╔══╝\r\n",
				"    ██║    █████╗   ███████╗    ██║   \r\n",
		...
		Test {
			name: String::from("Max length at 2 raw mode string"),
			args: vec!["test".to_string(), "-m".to_string(), "2".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				" ████████╗ ███████╗\r\n",
				" ╚══██╔══╝ ██╔════╝\r\n",
				"    ██║    █████╗  \r\n",
		...
		Test {
			name: String::from("Max length at 3 raw mode string"),
			args: vec!["test".to_string(), "-m".to_string(), "3".to_string(), "--raw-mode".to_string()],
			fixture: concat!("\r\n\r\n",
				" ████████╗ ███████╗ ███████╗\r\n",
				" ╚══██╔══╝ ██╔════╝ ██╔════╝\r\n",
				"    ██║    █████╗   ███████╗\r\n",
