...
mod tests {
	...
	fn plain_segments_are_spaces() {
		assert_plain_segments_are_spaces(&super::FONT_CHROME);
	}

	#[test]
	fn rows_stripe_their_slot() {
		assert_rows_stripe_their_slot(&super::FONT_CHROME);
	}

	#[test]
	fn buffer_start_size() {
		assert_buffer_start_size(&super::FONT_CHROME);
	}

	#[test]
	fn buffer_end_size() {
		assert_buffer_end_size(&super::FONT_CHROME);
	}
