...
pub static FONT_PALLET: FontFile<6> = FontFile {
	name: "pallet",
	#[rustfmt::skip]
	buffer_start: &[
...
mod tests {
	...
	#[test]
	fn pallet_test_colors_all_used() {
		assert_colors_all_used(&super::FONT_PALLET);
	}

	#[test]
	fn pallet_test_letter_space_size() {
		assert_letter_space_size(&super::FONT_PALLET);
	}

	#[test]
	fn pallet_test_buffer_start_size() {
		assert_buffer_start_size(&super::FONT_PALLET);
	}
