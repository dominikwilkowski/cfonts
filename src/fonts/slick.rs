...
pub static FONT_SLICK: FontFile<6> = FontFile {
	name: "slick",
	#[rustfmt::skip]
	buffer_start: &[
...
mod tests {
	...
	fn slick_test_colors_all_used() {
		assert_colors_all_used(&super::FONT_SLICK);
	}

	#[test]
	fn slick_test_letter_space_size() {
		assert_letter_space_size(&super::FONT_SLICK);
	}

	#[test]
	fn slick_test_buffer_start_size() {
		assert_buffer_start_size(&super::FONT_SLICK);
	}

	#[test]
	fn slick_test_buffer_end_size() {
		assert_buffer_end_size(&super::FONT_SLICK);
	}

	#[test]
	fn slick_test_buffers_plain() {
		assert_buffers_plain(&super::FONT_SLICK);
	}
}
